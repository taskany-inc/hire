...
import { CreateSolution, GetSolutionsBySectionId, SwitchSolutionsOrder, UpdateSolution } from './solutionTypes';
...
const getById = async (id: number, interviewerId?: number) => {
    const solution = await prisma.solution.findFirst({
        ...
        include: {
            ...
            section: {
                include: {
                    interview: { include: { sections: { include: { interviewers: true } } } },
                    interviewers: true,
                },
            },
        },
